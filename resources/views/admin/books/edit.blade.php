    ...
    <div class="p-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb small mb-0">
                ...
                <li class="breadcrumb-item active text-secondary">Edit Book
                </li>
            </ol>
        </nav>
                    ...
                    <div class="card border rounded-4 p-4 mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="title" name="title"
                                ...
                                value="{{ old('title', $book->title) }}" placeholder="e.g. Testing, Develop, Programming" required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="author" name="author"
                                ...
                                value="{{ old('author', $book->author) }}" placeholder="e.g. William Shakespeare, Charles Dickens" required>
                            @error('author')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description" name="description" rows="5"
                                ...
                                placeholder="Describe the book in detail...">{{ old('description', $book->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="price" name="price" step="0.01" min="0"
                                        ...
                                        value="{{ old('price', $book->price ?? '') }}" placeholder="0.00" required>
                                </div>
                                @error('price')
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="quantity" name="quantity" step="1" min="0"
                                        ...
                                        value="{{ old('quantity', $book->quantity) }}" placeholder="1...">
                                </div>
                                @error('quantity')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            @if (isset($book) && $book->image)
                                <div class="mb-3">
                                    ...
                                    <p class="text-secondary small mt-1 mb-0">Current image — upload a new one to
                                        replace it.</p>
                                </div>
                            @endif
